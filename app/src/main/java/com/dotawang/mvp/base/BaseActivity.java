...
import com.dotawang.mvp.utils.SoftInputUtils;
import com.dotawang.mvp.widget.dialog.LoadingActivityDialog;
...
public abstract class BaseActivity<T extends IBasePresenter,V> extends AutoLayoutActivity implements IBaseView<V>{
    ...
    public boolean dispatchTouchEvent(MotionEvent ev) {
        ...
        if (ev.getAction() == MotionEvent.ACTION_DOWN) {
            ...
            if (SoftInputUtils.isHideInput(view, ev)) {
                SoftInputUtils.HideSoftInput(view.getWindowToken(),
